...
<head>
<meta charset="UTF-8">
<title>Hadoop Programming</title>
       ...
       <form class="container" action="cAction.jsp" method="post">
          <div class="card">
   			<div class="card-header">
   				<h3 class="text-center">Hadoop Programming Language</h3>
   			</div>
   			<div class="card-body">
  	 			<div class="row">
   					<div class="col-lg-6">
     					<div class="form-group">
         					...
         					<input class="form-control" placeholder="Enter Course Name" name="course" value="Hadoop" readonly="readonly"></input>
    	 				</div>
   					</div>
				   <div class="col-lg-6">
