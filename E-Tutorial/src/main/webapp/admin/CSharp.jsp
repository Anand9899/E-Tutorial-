...
<head>
<meta charset="UTF-8">
<title>CSharp Programming</title>
  	 			...
  	 			<div class="row">
   					<div class="col-lg-6">
     					<div class="form-group">
         					...
         					<input class="form-control" placeholder="Enter Course Name" name="course" value="CSharp" readonly="readonly"></input>
    	 				</div>
   					</div>
				   <div class="col-lg-6">
